...
import 'package:manuelschneid/feature/auth/apply_here/controller/apply_here_controller.dart'
    show ApplyHereController;

class ApplyHereView extends StatelessWidget {
  ApplyHereView({super.key});

  final ApplyHereController controller = Get.put(ApplyHereController());
